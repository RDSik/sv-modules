...
void i2c_read_regs(UINTPTR Addr) {
    ...
    i2c_regs.data = Xil_In32(Addr + 20);
...
int i2c_test(UINTPTR Addr, uint32_t clk_freq) {
    ...
    Xil_Out32(Addr, i2c_regs.data);

    i2c_regs.clk.prescale = clk_freq/(5*100e3);
    Xil_Out32(Addr + 4, i2c_regs.data);

    i2c_regs.tx.data = I2C_WRITE_ADDR;
    Xil_Out32(Addr + 8, i2c_regs.data);
