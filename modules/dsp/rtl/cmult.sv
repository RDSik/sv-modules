...
module cmult #(
    ...
    input logic signed [1:0][A_DATA_WIDTH-1:0] a_tdata_i,
    input logic signed [1:0][B_DATA_WIDTH-1:0] b_tdata_i,
    input logic                                tvalid_i,

    output logic signed [1:0][A_WIDTH+B_DATA_WIDTH:0] tdata_o,
